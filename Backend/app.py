...
# import sys
# sys.path.append('mnt/c/home/sarthakjain/.local/lib/python3.10/site-packages/ffmpeg')

# import subprocess
# import sys

# # Add the directory containing your Python modules to sys.path
# sys.path.append('/mnt/c/home/sarthakjain/.local/lib/python3.10/site-packages')

# # Specify the full path to the ffmpeg executable within the WSL filesystem
# ffmpeg_path = '/mnt/c/Users/shubh/Downloads/ffmpeg-master-latest-win64-gpl-shared/ffmpeg-master-latest-win64-gpl-shared/bin/ffmpeg.exe'

# # Now you can use the ffmpeg_path variable in your code
